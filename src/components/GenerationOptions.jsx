  ...
  return (
    <section className={`${className}`}>
      <div className="flex flex-col gap-3">
        ...
        <input id="lengthSlider" type="range" min="1" max="18" onChange={e => dispatch({ type: "SET_LENGTH", payload: Number(e.target.value) })} value={state.length} className="accent-neon-green"/>
      </div>
